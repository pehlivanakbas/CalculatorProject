    ...
    private fun performCalculation() {
        ...
        if (number1 != null && number2 != null) {
            val result = when (state.operation) {
                ...
                is CalculatorOperation.Divide -> Log.e("işlem", "Bölme işlemi tanımlanmamıstır.")
             is   CalculatorOperation.Multiply -> Log.e("işlem", "Bölme işlemi tanımlanmamıstır.")
                is CalculatorOperation.Subtract -> Log.e("işlem", "Bölme işlemi tanımlanmamıstır.")
                null -> return
            }
            state = state.copy(
